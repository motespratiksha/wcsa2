...
public class usingfilter {
	...
	public static void main(String[] args) throws InterruptedException
	{
		 System.setProperty("webdriver.chrome.driver","./drivers/chromedriver.exe");
		  ...
		  String price = driver.findElement(By.xpath("//div[@class='_4rR01T' and text()='HP 14s Core i5 10th Gen - (8 GB/512 GB SSD/Windows 10 Home) 14s- ER0503TU Thin and Light Laptop']/ancestor::div[@class='_3pLy-c row']/descendant::div[@class='_30jeq3 _1_WHN1']")).getText();
